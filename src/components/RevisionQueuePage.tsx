...
const styles = StyleSheet.create({
  ...
  card: { minHeight: 270, flexDirection: 'row', backgroundColor: colors.panelRaised, borderWidth: 1, borderColor: colors.border, borderRadius: 14, overflow: 'hidden', marginBottom: 14 }, subletCard: { borderColor: '#5E472D' }, ribbon: { width: 6, backgroundColor: '#F97316' }, subletRibbon: { backgroundColor: '#B87834' }, cardContent: { flex: 1, padding: 18 }, vehicleEyebrow: { color: colors.muted, fontSize: 10, fontWeight: '800', letterSpacing: 1.1, marginBottom: 6 }, vehicleName: { color: colors.text, fontSize: 20, fontWeight: '900' }, rule: { height: 1, backgroundColor: colors.border, marginVertical: 14 }, metaRow: { flexDirection: 'row', gap: 20 }, meta: { flex: 1 }, metaLabel: { color: colors.subtle, fontSize: 8, fontWeight: '900', letterSpacing: 1, marginBottom: 4 }, metaValue: { color: '#D6DADE', fontSize: 12, fontWeight: '800' }, subletType: { color: '#E8B776', fontSize: 12, lineHeight: 16, fontWeight: '900' }, waiting: { color: '#F59E0B', fontSize: 12, fontWeight: '900' }, reasonLabel: { color: colors.subtle, fontSize: 8, fontWeight: '900', letterSpacing: 1, marginTop: 15, marginBottom: 4 }, reason: { color: '#F3B077', fontSize: 14, fontWeight: '900' }, notesLabel: { color: colors.subtle, fontSize: 8, fontWeight: '900', letterSpacing: 1, marginTop: 13, marginBottom: 4 }, notes: { color: '#BFC5CB', fontSize: 12, lineHeight: 17 }, pending: { color: '#E2A55F', fontSize: 9, fontWeight: '900', letterSpacing: 1.1, marginTop: 14 }, noNotes: { color: colors.subtle, fontStyle: 'italic' }, reviewLink: { color: colors.accent, fontSize: 9, fontWeight: '900', letterSpacing: 1.2, marginTop: 15 }, pressed: { opacity: 0.72 },
